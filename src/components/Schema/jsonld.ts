...
export function JsonLd<T extends Thing>(item: WithContext<T>, space?: string | number): string;
export function JsonLd(item: Graph | WithContext<Thing>, space?: string | number): string {
